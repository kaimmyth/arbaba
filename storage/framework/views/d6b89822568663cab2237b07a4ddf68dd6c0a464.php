                  ...
                  <?php $__currentLoopData = $toReturn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <tr>
                      ...
                      <td style="color: #0077C5; font-weight: 600; cursor: pointer;">Edit <i class="fa fa-caret-down" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: black; font-size: 15px;"></i>
                        ...
                        <a href="<?php echo e(url('sale/products-and-services/delete/'.$items['id'])); ?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete <i class="fas fa-trash"></i></a>
                      </td>
...
<form action="<?php echo e(url('sale/products-and-services/add')); ?>" method="POST">
  <?php echo csrf_field(); ?>
