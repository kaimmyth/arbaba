                                            ...
                                            <tbody>
                                                ...
                                                <?php $__currentLoopData = $return; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        ?>
                                                        <td><?php echo e(rtrim($category, ', ')); ?></td>
                                                        <td><?php echo e($payment_amount); ?></td>
                                                        <td><?php echo e($tax_amount); ?></td>
                                                        <td><?php echo e($payment_amount+$tax_amount); ?></td>
                                                        <td><a href="javascript:void();" onclick="viewEditExpenses('view', <?php echo e($items['id']); ?>);"><i class="fas fa-eye"></i></a> &nbsp; <a href="javascript:void();" onclick="viewEditExpenses('edit', <?php echo e($items['id']); ?>);"><i class="fas fa-pencil-alt"></i></a> &nbsp; <a href="<?php echo e(url('expenses/delete/'.$items['id'])); ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fas fa-trash"></i></a></td>
                                                    </tr>
                                                    <?php $sl_no++; ?>
...
<form action="<?php echo e(url('expenses/add-edit')); ?>" method="POST" enctype="multipart/form-data" id="form-expenses">
    <?php echo csrf_field(); ?>
    <!---------------------------------------modal start-------------------------------------------->                   
...
function viewEditExpenses(purpose, id){
    ...
    $.ajax({
        url: "<?php echo e(url('expenses/get-expanses-details')); ?>" + "/" + id,
        method: "GET",
        ...
        success: function (data) {
            ...
            {  
                ...
                $("#e_expenses_attachment").html("<a target='_blank' href='<?php echo e(url('public/images')); ?>"+"/"+data.attachment+"'>View Previous Attachment</a>");
