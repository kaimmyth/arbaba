...
<!-- Custom Modals -->
	...
	<div class="modal-dialog" style="width:55%">
		...
		<div class="modal-body">
        <form action="<?php echo e(url('tax/payment-history/add')); ?>" method="POST" id="form-payment-history">
          <?php echo csrf_field(); ?>
			<div class="row">
			<div class="col-md-5">
				<div class="form-group">
...
<script>
    ...
    function viewEditEmployee(purpose, id){
        ...
        $.ajax({
            url: "<?php echo e(url('tax/payment-history/get-payment-details')); ?>" + "/" + id,
            method: "GET",
