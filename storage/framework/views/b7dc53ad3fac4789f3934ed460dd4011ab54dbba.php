                                ...
                                <tbody>
                                    <?php $sl_no=1; ?>
                                        ...
                                        <?php $id=$value['id']; ?>
                                            ...
                                            <td class="actions">
                                                <a href="#" class="on-default edit-row" data-terms_id="<?php echo e($id); ?>" data-terms_terms="<?php echo e($value['terms']); ?>"
                                                data-toggle="modal" data-target="#edit_model_practic" title="edit" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
                                                <a href="<?php echo e(url('terms/delete/'.$value['id'])); ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fas fa-trash"></i></a>
                                            </td>
                                            <!-- <td></td> -->
    ...
    <div class="modal-dialog"> 
        <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                <form action ="<?php echo e(url('terms/update')); ?>" method="post">
                    <div class="row"> 
                        <div class="col-md-12"> 
...
<?php /**PATH C:\xampp\htdocs\arbaba\resources\views/terms.blade.php ENDPATH**/ ?>