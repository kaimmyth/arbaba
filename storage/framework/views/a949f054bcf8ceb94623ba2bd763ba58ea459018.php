    ...
    <div class="modal-dialog"> 
        <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                <form action ="<?php echo e(url('tools-master/update_state')); ?>" method="post">
                    <div class="row"> 
                        <div class="col-md-12"> 
    ...
    <div class="modal fade bs-example-modal-md recurring-expenses" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <form action="<?php echo e(url('tools-master/add_new_state')); ?>" method="POST">
                   <?php echo csrf_field(); ?>
                    <div class="col-md-12">
                        <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\arbaba\resources\views/tools-master/state.blade.php ENDPATH**/ ?>