    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <ol class="breadcrumb pull-right">
            ...
            <li><a href="<?php echo e(URL::to('home')); ?>">Company</a></li>
        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <tbody>
                <?php $__currentLoopData = $cmpnydata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td><img src="<?php echo e(asset('public/images/company/'.$val->photo)); ?>" width="50" height="40"></td>
                  <td><?php echo e($val->org_name); ?></td>
                  <td><?php echo e($val->contact_no); ?></td>
                  <td><?php echo e($val->email); ?></td>
                  <td><?php echo e($val->website); ?></td>
                  <td class="actions">
                    <a href="javascript::void(0)" onclick="editCompany(<?php echo e($val->id); ?>)" data-toggle="tooltip"
                      data-placement="top" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>
                      &nbsp;&nbsp;&nbsp;
                      <a href="javascript::void(0)" onclick="viewCompany(<?php echo e($val->id); ?>)" data-toggle="tooltip"
                        data-placement="top" title="" data-original-title="View"><i class="fa fa-eye"></i></a>

                        &nbsp;&nbsp;&nbsp;
                        <a href="<?php echo e(URL::to('company/destroy',$val->id)); ?>"
      ...
      <script type="text/javascript">
        function editCompany(id) {
          ...
          $.ajax({
            url: "<?php echo e(url('company/edit/')); ?>" + '/' + id,
            method: "POST",
      ...
      var public_path = <?php echo json_encode(url('public')); ?>;
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="<?php echo e(URL::to('company/store')); ?>" method="POST" id="FormValidation" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
              ...
              <div class="col-md-3 pro">
                <div class="container">
                  <div class="picture-container">
                    <div class="picture">
                      <img src="<?php echo e(asset('public/assets/images/user.png')); ?>" class="picture-src" style="width: 100px;
...
<!-- /.End modal --><?php /**PATH C:\xampp\htdocs\arbaba\resources\views/admin/company/Company-Listing.blade.php ENDPATH**/ ?>