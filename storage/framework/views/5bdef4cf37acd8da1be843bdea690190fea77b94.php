                  ...
                  <tbody>
                     ...
                     <tr>
                      ...
                      <div class="dropdown-menu resp" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="<?php echo e(url('sale/customer_estimate/'.$items1['id'])); ?>">Create Customer Statement</a>
                      ...
                      <a class="dropdown-item" href="<?php echo e(url('sale/customer/delete/'.$items1['id'])); ?>">Delete</a>
                       <a class="dropdown-item"  onclick="editCustomer(<?php echo e($items1['id']); ?>);" href="javascript:void();">Edit</a>
                      </div>
                    </td>
    ...
    <div class="modal fade bs-example-modal-lg customer-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form action="<?php echo e(url('sale/customers/add')); ?>" method="POST" enctype="multipart/form-data" id="customer-form">
          <?php echo csrf_field(); ?>
            ...
            <div class="col-md-12">
              ...
              <div class="tab-content" style="border: 1px solid;">
                <div class="tab-pane  show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                 ...
                 <?php $__currentLoopData = $state; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <option value="<?php echo e($state1->state); ?>" ><?php echo e($state1->state); ?> </option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-6" style="margin-top: 6px;">
                            <!--    <input type="text" class="form-control" id="country" name="country" placeholder="Country" >---->
                                  ...
                                  <option value="<?php echo e($countries['country']); ?>" ><?php echo e($countries['country']); ?> </option>
                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <!-----   <option>Andhra Pradesh</option>
                 ...
                 <?php $__currentLoopData = $state; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <option value="<?php echo e($state2['state']); ?>" ><?php echo e($state2['state']); ?> </option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
...
function editCustomer(id){
    ...
    $.ajax({
        url: "<?php echo e(url('sale/customer/get_customer_details')); ?>" + "/" + id,
        method: "GET",
        ...
        success: function (data) {
            ...
            $("#e_attachment").html("<a target='_blank' href='<?php echo e(url('public/images')); ?>"+"/"+data.attachment+"'>View Previous Attachment</a>");
            $("#e_contact_attachment").html("<a target='_blank' href='<?php echo e(url('public/images')); ?>"+"/"+data.contact_attachment+"'>View Previous Attachment</a>");
...
<?php /**PATH C:\xampp\htdocs\arbaba\resources\views/sale/customer.blade.php ENDPATH**/ ?>