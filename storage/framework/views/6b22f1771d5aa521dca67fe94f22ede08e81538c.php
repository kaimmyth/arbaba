            ...
            <div  style="border-style:lightgrey;background-color:rgb(240, 240, 240); padding: 20px; !important">
               ...
               $customer_details=DB::table('sales_customers')->where('id',$value['customer'])->first();
                ...
                <div class="col-md-12"> 
                    <div class="col-md-12">
                        <div>
                            <h3><b><?php echo e(@$customer_details->company); ?></b></h3>
                            <h4><?php echo e(@$customer_details->first_name); ?></h4>
                            <h4><?php echo e(@$value['billing_address']); ?></h4>
                            <h4><?php echo e(@$customer_details->email_id); ?></h4>
                            <h4><?php echo e(@$customer_details->mobile_no); ?></h4>
                        </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <h4><b>INVOICE TO</b></h4><?php echo e(@$customer_details->billing_address); ?>

                        </div>
                    </div>  
                    <div class="col-md-4">
                        <div class="form-group">
                            <h4><b>SHIPPED TO</b></h4><?php echo e(@$customer_details->shipping_address); ?>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                                <h5><b>INVOICE NO :</b>&nbsp;&nbsp;<?php echo e(@$customer_details->invoice_no); ?></h5>
                                <h5><b>DATE :</b>&nbsp;&nbsp;<?php echo e(@$customer_details->due_date); ?></h5>
                                <h5><b>DUE DATE :</b>&nbsp;&nbsp;<?php echo e(@$customer_details->due_date); ?></h5>
                                <h5><b>TERMS :</b>&nbsp;&nbsp;<?php echo e(@$customer_details->terms); ?></h5>   
                         </div>  
...
</html><?php /**PATH C:\xampp\htdocs\arbaba\resources\views/sale/sales_all_sales_print.blade.php ENDPATH**/ ?>