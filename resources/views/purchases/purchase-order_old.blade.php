            ...
            <div class="row">
              <div class="col-md-12" style="text-align: right;">
                <tr>
                  ...
                  <td>
                    <h4>Discount &nbsp; &nbsp;<i class="fa fa-rupee-sign sz" aria-hidden="true"></i><span id="taxes-span"><span>0.00</h4>
                  </td>
                  <td>
                    <h4>Adjustment &nbsp; &nbsp;<i class="fa fa-rupee-sign sz" aria-hidden="true"></i><span id="total-span">0.00</span></h4>
                  </td>
                </tr>
              </div>
            </div>
