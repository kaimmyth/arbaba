...
<body class="fixed-left" id="loader" >
  ...
  <div class="preload popupbox loader1" id="loader1" style="display:none;">
    <div class="popup">
      <center>
        <span class="loader12" style="display:block;"><img src="{{url('public/assets/images/loader.gif')}}" height="70" /></span>
      </center>
    </div>
  </div>
  <!-- Begin page -->
    ...
    <div class="topbar">
      ...
      <div class="topbar-left">
        <div class="text-center">
          <a href="{{ URL::to('dashboard')}}" class="logo"><i class="md md-terrain"></i> <span>AR Baba</span></a>
        </div>
      </div>
          ...
          <ul class="nav navbar-right float-right list-inline">
            <li class="dropdown d-none d-sm-block">
              ...
              <li class="dropdown open">
                @php  $logo = DB::table('org')->where('users_id',Auth::user()->id)->selectRaw("concat('".url('public/images/company/').'/'."',photo) as logo")->first();  @endphp
                <a href="#" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img src="@if(@$logo->logo!='') {{ @$logo->logo}} @else {{ asset('public/assets/images/users/avatar-1.jpg') }} @endif" alt="user-img" class="rounded-circle"> &nbsp;&nbsp;{{Auth::user()->username}} </a>
