                                ...
                                <tbody> 
                                    @foreach ($toReturn as $value)
                                        <tr>
                                                ...
                                                <td>{{$value['department_type']}}</td>
                                                <td>{{$value['department_hod']}}</td>
                                                <td>{{$value['company_name']}}</td>
                                                <td>{{$value['branch']}}</td>
                                                <td class="actions">
                                                    <a href="javascript:void();" onclick="vieweditdepartment('view', {{$value['id']}});"><i class="fas fa-eye"></i></a> &nbsp;
                                                   <a href="javascript:void();" onclick="vieweditdepartment('edit', {{$value['id']}});"><i class="fas fa-pencil-alt"></i></a> &nbsp; 
                                                    <a href="{{url('tools-master/delete/department/'.$value['id'])}}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fas fa-trash"></i></a>
                                                </td>
                                        </tr>
                                         @endforeach
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{url('tools-master/add_department')}}" method="POST" id="form-department">
                        @csrf
...
function vieweditdepartment(purpose, id){
    ...
    $.ajax({
        url: "{{url('tools-master/get-department-details')}}" + "/" + id,
        method: "GET",
