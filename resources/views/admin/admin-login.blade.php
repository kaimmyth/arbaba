...
<body>
  ...
  <div class="preload popupbox loader1" id="loader1" style="display:none;">
    <div class="popup">
        <center>
            <span class="loader12" style="display:block;"><img src="{{asset('public/assets/images/loader.gif')}}" height="100" /></span>
        </center>
    </div>
</div>
<div class="wrapper-page">
    <div class="card card-pages" style="background-color: #e0e0e0;">
        <div class="card-header"> 
            <img src="{{ asset('public/assets/images/logo.png')}}" style="height: 73px; margin-left: 120px;">
