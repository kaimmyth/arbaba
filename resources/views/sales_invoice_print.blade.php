                ...
                @foreach ($toReturn as $value)
                    ...
                    <div class="row">
                            ...
                            $customer_name=DB::table('sales_customers')->where('id',$value['customer_name'])->value('display_name_as');
                             ...
                             @endphp
                            <td scope="col"><b>BILL TO</b>:&nbsp&nbsp{{$customer_name}}</td>
                            <td scope="col"></td>
                            <td scope="col"></td>
                            <td scope="col"></td>
                            <td scope="col"></td> 
                            ...
                            <td scope="col"></td>
                            <td scope="col"></td>
                            <td scope="col">INVOICE NO:{{$value['invoice_no']}}</h5>
                            </tr>
                            <tr>
                            <td scope="col">EMAIL:{{$value['customer_email']}}</td>
                            <td scope="col"></td>
                            <td scope="col"></td>
                            <td scope="col"></td>
                            <td scope="col"></td> 
                            ...
                            <td scope="col"></td>
                            <td scope="col"></td>
                            <td scope="col">DATE:{{$value['invoice_date']}}</td>
                            </tr>
                            <tr>
                            <td  scope="col">{{$value['billing_address']}}</td>
                            <td scope="col"></td>
                            <td scope="col"></td>
                            <td scope="col"></td>
                            <td scope="col"></td> 
                            ...
                            <td scope="col"></td>
                            <td scope="col"></td>
                            <td scope="col">DUE DATE:{{$value['due_date']}}</td>
                            </tr>
                            <!-- <tr>
                            <td scope="col">DUE DATE:{{$value['due_date']}}</td>
                            <td scope="col"></td>
                            ...
                            $customer_name=DB::table('sales_customers')->where('id',$value['customer_name'])->value('display_name_as');
                             @endphp -->
                              <!-- <h5><b>BILL TO :</b>&nbsp;&nbsp;{{$customer_name}}</h5> -->
                              <!-- <h5><b>EMAIL:</b>&nbsp;&nbsp;{{$value['customer_email']}}</h5> -->
                               <!-- <div>{{$value['billing_address']}}</div> -->
